...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("blank").addEventListener("click", () => {
    ...
    win.eval(
      `let selenite = document.getElementById("selenite");console.log(selenite);selenite.setAttribute("src", "${location.origin}");console.log(selenite);document.getElementById("goBack").addEventListener("click", function () {selenite.contentDocument.location.href = selenite.contentDocument.location.origin;});document.getElementById("reload").addEventListener("click", function () {selenite.contentDocument.location.href = selenite.contentDocument.location.href;})`
    );
...
loadScript("https://cdn.jsdelivr.net/gh/proudparrot2/quick.js/quick.js", function () {
  console.log("Script loaded successfully.");
  function getRandomNumber() {
    return Math.floor(1e6 * Math.random()) + 1;
  }
  if (1 === getRandomNumber()) {
    var a = _.get(".chan");
    _.edit(a, "selentine.");
  }
});
function loadUnderscore(e) {
  var t = document.createElement("script");
  (t.src = "https://underscorejs.org/underscore-min.js"), (t.onload = e), document.head.appendChild(t);
}
